 ...
 * @date 2017/11/28
 */
public class MallCategoryRepository {
    private final EbeanServer ebeanServer;
    private final DatabaseExecutionContext executionContext;

    @Inject
    public MallCategoryRepository(EbeanConfig ebeanConfig, DatabaseExecutionContext executionContext) {
     ...
     * @return
     */
    public PagedList<MallCategory> find(String name, String mall, String flg, int page, int pageSize, String validFlg) {
